...
func newBaseStreamWriter[T any](engine *RelayRTCEngine, header *protocol.DataStream_Header, streamId string, destinationIdentities []string, totalSize *uint64, onProgress func(progress float64)) *baseStreamWriter[T] {
...
func newTextStreamWriter(info TextStreamInfo, header *protocol.DataStream_Header, e *RelayRTCEngine, destinationIdentities []string, onProgress func(progress float64)) *TextStreamWriter {
...
func newByteStreamWriter(info ByteStreamInfo, header *protocol.DataStream_Header, e *RelayRTCEngine, destinationIdentities []string, onProgress func(progress float64)) *ByteStreamWriter {
